...
const createStorage = (subDirectory: string) => {
...
export const getImageUrl = (req: any, filename: string, subDirectory: string = '') => {
...
export const cleanupOldFiles = (directory: string, maxAgeInDays: number = 30) => {
  try {
